...
`toloka.client.message_thread.MessageThreadCompose` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.0.1/src/client/message_thread.py#L171)
...
`answerable`|**Optional\[bool\]**|<p>Ability to reply to a message:<ul><li>True — The Toloker can respond to the message.</li><li>False — The Toloker can&#x27;t respond to the message.</li></ul></p>
