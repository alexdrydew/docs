...
`toloka.client.task_distribution_function.TaskDistributionFunction` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.0.1/src/client/task_distribution_function.py#L9)
...
| :----------| :----| :-----------|
`scope`|**Optional\[[Scope](toloka.client.task_distribution_function.TaskDistributionFunction.Scope.md)\]**|<p>How to count tasks completed by the Toloker:<ul><li>POOL - Count completed pool tasks.</li><li>PROJECT - Count completed project tasks.</li></ul></p>
